    ...
    if (isLogin) {
      const unsubscribe = auth.onAuthStateChanged((user) => {
        if (user) {
          ...
          const { displayName, email, photoURL, uid, phoneNumber, datePorn } = providerData
          setCurrentUser({
            displayName: 'Ngoc Thanh',
            email,
            photoURL: 'https://pbs.twimg.com/profile_images/1534202050304614402/CCmKYCSS_400x400.jpg',
            uid,
